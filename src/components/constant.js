...
export const experiences = [
  {
    ...
    points: [
      "Led a cross-functional team of 5+ developers to design and deliver scalable fintech applications using React.js, Node.js, and NestJS in an Agile environment.",
      "Architected and implemented Backend-for-Frontend (BFF) services using Node.js and Express to aggregate microservice data and optimize frontend performance.",
      "Developed and maintained RESTful APIs using Node.js, NestJS, and Express, supporting React-based Micro Frontend (MFE) applications.",
      "Designed and optimized database solutions using PostgreSQL and MongoDB, improving query performance and reducing response time by 20%.",
      "Implemented JWT-based authentication and advanced security headers (XSS protection, X-Frame-Options, Referrer Policy) to strengthen application security.",
      "Designed secure AES-256-CTR encryption workflows with HMAC for protecting sensitive user data.",
      "Deployed and maintained applications on AWS (EC2, S3, Elastic Beanstalk) with automated CI/CD pipelines using CodePipeline and Docker.",
      "Built scalable UI components using React.js, Redux, and TypeScript, improving application usability and maintainability.",
      "Led UI modernization initiatives, increasing customer engagement by 40%.",
      "Integrated third-party APIs, including SMS, email, and payment services, to enhance customer communication and transaction flows.",
      "Enforced unit and integration testing using Jest and React Testing Library, improving release stability and code quality.",
    ],
  },
  {
